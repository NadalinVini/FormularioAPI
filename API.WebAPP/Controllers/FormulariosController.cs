...
namespace API.WebAPP.Controllers
{
    public class FormulariosController : Controller
    {
        ...
        public FormulariosController(DataContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ID,Nome,Sobrenome,Telefone")] Formulario formulario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Nome,Sobrenome,Telefone")] Formulario formulario)
        {
            if (id != formulario.ID)
            {
                return NotFound();
